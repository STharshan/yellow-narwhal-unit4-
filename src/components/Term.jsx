          ...
          <div className="max-w-6xl mx-auto">
              ...
              <div className="mt-8 space-y-6">
                  ...
                  <section>
                      ...
                      <p className="text-white">
                          All content on this website (including text, images, graphics, and logos) is owned by or licensed to Unit4 Remapping Specialist.
                  ...
                  <section>
                      ...
                      <div className="text-white">
                          <p><strong>Unit4 Remapping Specialist</strong></p>
                          <p>Email: <a href="mailto:malen@email.com" className="text-blue-500 hover:underline">malen@email.com</a></p>
