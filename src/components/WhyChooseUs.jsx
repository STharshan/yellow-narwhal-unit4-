...
export default function WhyChooseUs() {
  ...
  return (
    <div className="bg-white text-center py-20 px-4 md:px-8 max-w-7xl mx-auto">
      <p className="flex items-center justify-center gap-2 text-blue-700 font-semibold uppercase tracking-wider mb-2">
        <LuAlignRight className="text-blue-700 text-lg" />
        Built for Results
      </p>
      <h2 className="text-3xl md:text-5xl font-bold mb-4">Why Choose Us?</h2>
      <p className="text-lg text-gray-600 mb-12 max-w-6xl mx-auto">
        At <span className="font-bold">Unit Four</span>, we do more than just fix cars — we unlock their full potential. Here’s why drivers across Leicester trust us with their vehicles:
      </p>
